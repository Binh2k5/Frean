          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              <li class="nav-item active">
                <a class="nav-link" href="<%=request.getContextPath()%>/User/HomePage">Home <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
             ...
             <c:if test="${not empty author}">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right p-3" aria-labelledby="searchDropdown" style="min-width: 300px;">
                  <form class="form-inline" action="<%=request.getContextPath()%>/User/Search" method="post">
    ...
    <section class="slider_section ">
      <div id="customCarousel1" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
         <c:forEach items="${top3}" var="top3" varStatus="status">
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">                        
                        <a href="<%=request.getContextPath()%>/User/Cart?dishId=${top3.id}" class="btn1">
                          Order Now
                        </a>                        
                    </div>
                  </div>
        ...
        <div class="row">
         <c:forEach items="${top2}" var="top2">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="<%=request.getContextPath()%>/images/${top2.image}" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tasty Thursdays
                ...
                <h6>
                  ...
                  <a href="<%=request.getContextPath()%>/User/Cart?dishId=${top2.id}">
  ...
  <section class="food_section layout_padding-bottom">
    <div class="container">
      ...
      <div class="filters-content">
        <div class="row grid">
         <c:forEach items="${top9}" var="d">
          <div class="col-sm-6 col-lg-4 all ${d.category}">
            <div class="box">
              <div>
                <div class="img-box">
                  <img src="<%=request.getContextPath()%>/images/${d.image}">
                </div>
                <div class="detail-box">
                  <h5>
                    ${d.name}
        ...
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="<%=request.getContextPath()%>/images/client1.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="img-box">
                <img src="<%=request.getContextPath()%>/images/client2.jpg" alt="" class="box-img">
              </div>
            </div>
          </div>
        </div>
