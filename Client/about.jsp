        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  mx-auto ">
              <li class="nav-item ">
                <a class="nav-link" href="${pageContext.request.contextPath}/User/HomePage">Home </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/User/Menu">Menu</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="<%=request.getContextPath()%>/User/About">About <span class="sr-only">(current)</span> </a>
              </li>              
            </ul>
            <div class="user_option">
             ...
             <c:if test="${not empty author}">
              ...
              <a href="${pageContext.request.contextPath}/User/Checkout" class="order_online">
                Order Online
              </a>
            </div>
          </div>
